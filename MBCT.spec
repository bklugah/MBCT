...
"""
MBCT.spec — MBCT (full edition): every tab.

Home, Analysis, Results, Brain Viewer, Connectivity, Utilities (all six tools),
Help. Ships the complete reference data set.

Build on the TARGET OS (no cross-compiling):
    pyinstaller MBCT.spec --noconfirm
Output: dist/MBCT/
"""
...
print("=" * 62)
print("Building MBCT — FULL edition (all tabs)")
print("=" * 62)
...
coll = COLLECT(exe, a.binaries, a.zipfiles, a.datas,
               strip=False, upx=False, upx_exclude=[], name='MBCT')

if sys.platform == 'darwin':
    app = BUNDLE(coll, name='MBCT.app', icon=icon_for(ROOT),
                 bundle_identifier='com.bklugah.mbct')
